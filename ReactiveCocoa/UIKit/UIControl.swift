...
extension Reactive where Base: UIControl {
	...
	internal func makeValueBindable<U>(setValue: @escaping (Base, U) -> Void, values: @escaping (Reactive<Base>) -> Signal<U, NoError>, actionDidBind: ((Base, ActionStates) -> Void)? = nil) -> ValueBindable<U> {
